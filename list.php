...
<body>
    ...
    <form class=" text-center d-flex justify-content-center border-bottom border-danger" style="margin:1rem; padding:1rem" name="invoiceForm" action="list.php" method="post">
